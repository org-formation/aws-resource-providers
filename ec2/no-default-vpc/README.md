...
1. Write the JSON schema describing your resource, [community-ec2-nodefaultvpc.json](./community-ec2-nodefaultvpc.json)
2. Implement your resource handlers in [handlers.ts](./community-ec2-nodefaultvpc/handlers.ts)

> Don't modify [models.ts](./community-ec2-nodefaultvpc/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
