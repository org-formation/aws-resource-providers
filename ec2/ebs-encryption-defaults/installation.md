...
aws cloudformation create-stack \
  --template-url https://community-resource-provider-catalog.s3.amazonaws.com/community-ec2-ebsencryptiondefaults-resource-role-0.1.0.yml \
  --stack-name community-ec2-ebsencryptiondefaults-resource-role \
