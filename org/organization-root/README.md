...
1. Write the JSON schema describing your resource, [oc-org-organizationroot.json](./oc-org-organizationroot.json)
2. Implement your resource handlers in [handlers.ts](./oc-org-organizationroot/handlers.ts)

> Don't modify [models.ts](./oc-org-organizationroot/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
