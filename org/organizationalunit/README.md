...
1. Write the JSON schema describing your resource, [oc-org-organizationalunit.json](./oc-org-organizationalunit.json)
2. Implement your resource handlers in [handlers.ts](./oc-org-organizationalunit/handlers.ts)

> Don't modify [models.ts](./oc-org-organizationalunit/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
