...
1. Write the JSON schema describing your resource, [oc-org-servicecontrolpolicy.json](./oc-org-servicecontrolpolicy.json)
2. Implement your resource handlers in [handlers.ts](./oc-org-servicecontrolpolicy/handlers.ts)

> Don't modify [models.ts](./oc-org-servicecontrolpolicy/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
