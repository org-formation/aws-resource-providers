...
1. Write the JSON schema describing your resource, [oc-org-account.json](./oc-org-account.json)
2. Implement your resource handlers in [handlers.ts](./oc-org-account/handlers.ts)

> Don't modify [models.ts](./oc-org-account/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
