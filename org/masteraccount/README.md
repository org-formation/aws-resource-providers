...
1. Write the JSON schema describing your resource, [oc-org-masteraccount.json](./oc-org-masteraccount.json)
2. Implement your resource handlers in [handlers.ts](./oc-org-masteraccount/handlers.ts)

> Don't modify [models.ts](./oc-org-masteraccount/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
