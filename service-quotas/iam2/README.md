...
1. Write the JSON schema describing your resource, [community-servicequotas-iam.json](./community-servicequotas-iam.json)
2. Implement your resource handlers in [handlers.ts](./community-servicequotas-iam/handlers.ts)

> Don't modify [models.ts](./community-servicequotas-iam/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
