...
1. Write the JSON schema describing your resource, [oc-servicequotas-cloudformationquotas.json](./oc-servicequotas-cloudformationquotas.json)
2. Implement your resource handlers in [handlers.ts](./oc-servicequotas-cloudformationquotas/handlers.ts)

> Don't modify [models.ts](./oc-servicequotas-cloudformationquotas/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
