...
1. Write the JSON schema describing your resource, [community-account-alternatecontact.json](./community-account-alternatecontact.json)
2. Implement your resource handlers in [handlers.ts](./community-account-alternatecontact/handlers.ts)

> Don't modify [models.ts](./community-account-alternatecontact/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
