...
``` yaml
CommunityCodeCommitApprovalRuleTemplateRP:
  Type: register-type
  SchemaHandlerPackage: s3://community-resource-provider-catalog/community-codecommit-approvalruletemplate-0.1.0.zip
  ResourceType: 'Community::CodeCommit::ApprovalRuleTemplate'
