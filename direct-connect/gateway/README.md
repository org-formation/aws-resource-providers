...
1. Write the JSON schema describing your resource, [community-directconnect-gateway.json](./community-directconnect-gateway.json)
2. Implement your resource handlers in [handlers.ts](./community-directconnect-gateway/handlers.ts)

> Don't modify [models.ts](./community-directconnect-gateway/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
