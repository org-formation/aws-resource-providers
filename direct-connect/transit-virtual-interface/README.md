...
1. Write the JSON schema describing your resource, [community-directconnect-transitvirtualinterface.json](./community-directconnect-transitvirtualinterface.json)
2. Implement your resource handlers in [handlers.ts](./community-directconnect-transitvirtualinterface/handlers.ts)

> Don't modify [models.ts](./community-directconnect-transitvirtualinterface/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
