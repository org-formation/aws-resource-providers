...
1. Write the JSON schema describing your resource, [community-cloudformation-typeconfiguration.json](./community-cloudformation-typeconfiguration.json)
2. Implement your resource handlers in [handlers.ts](./community-cloudformation-typeconfiguration/handlers.ts)

> Don't modify [models.ts](./community-cloudformation-typeconfiguration/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
