...
1. Write the JSON schema describing your resource, [community-iam-managedpolicystatement.json](./community-iam-managedpolicystatement.json)
2. Implement your resource handlers in [handlers.ts](./community-iam-managedpolicystatement/handlers.ts)

> Don't modify [models.ts](./community-iam-managedpolicystatement/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
