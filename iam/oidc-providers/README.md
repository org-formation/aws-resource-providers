...
1. Write the JSON schema describing your resource, [community-iam-openidconnectprovider.json](./community-iam-openidconnectprovider.json)
2. Implement your resource handlers in [handlers.ts](./community-iam-openidconnectprovider/handlers.ts)

> Don't modify [models.ts](./community-iam-openidconnectprovider/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
