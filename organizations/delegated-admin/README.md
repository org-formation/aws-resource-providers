...
1. Write the JSON schema describing your resource, [community-organizations-delegatedadmin.json](./community-organizations-delegatedadmin.json)
2. Implement your resource handlers in [handlers.ts](./community-organizations-delegatedadmin/handlers.ts)

> Don't modify [models.ts](./community-organizations-delegatedadmin/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
