...
1. Write the JSON schema describing your resource, [community-fms-adminaccount.json](./community-fms-adminaccount.json)
2. Implement your resource handlers in [handlers.ts](./community-fms-adminaccount/handlers.ts)

> Don't modify [models.ts](./community-fms-adminaccount/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
