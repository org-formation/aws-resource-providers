...
1. Write the JSON schema describing your resource, [oc-servicequotas-s3.json](./oc-servicequotas-s3.json)
2. Implement your resource handlers in [handlers.ts](./oc-servicequotas-s3/handlers.ts)

> Don't modify [models.ts](./oc-servicequotas-s3/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
