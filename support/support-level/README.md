...
1. Write the JSON schema describing your resource, [community-support-supportlevel.json](./community-support-supportlevel.json)
2. Implement your resource handlers in [handlers.ts](./community-support-supportlevel/handlers.ts)

> Don't modify [models.ts](./community-support-supportlevel/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
