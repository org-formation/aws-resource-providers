...
1. Write the JSON schema describing your resource, [community-networkmanager-acceptattachment.json](./community-networkmanager-acceptattachment.json)
2. Implement your resource handlers in [handlers.ts](./community-networkmanager-acceptattachment/handlers.ts)

> Don't modify [models.ts](./community-networkmanager-acceptattachment/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
