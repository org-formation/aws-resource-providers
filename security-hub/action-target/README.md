...
1. Write the JSON schema describing your resource, [community-securityhub-actiontarget.json](./community-securityhub-actiontarget.json)
2. Implement your resource handlers in [handlers.ts](./community-securityhub-actiontarget/handlers.ts)

> Don't modify [models.ts](./community-securityhub-actiontarget/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
