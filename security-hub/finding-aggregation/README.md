...
1. Write the JSON schema describing your resource, [community-securityhub-findingaggregation.json](./community-securityhub-findingaggregation.json)
2. Implement your resource handlers in [handlers.ts](./community-securityhub-findingaggregation/handlers.ts)

> Don't modify [models.ts](./community-securityhub-findingaggregation/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
