...
1. Write the JSON schema describing your resource, [community-securityhub-members.json](./community-securityhub-members.json)
2. Implement your resource handlers in [handlers.ts](./community-securityhub-members/handlers.ts)

> Don't modify [models.ts](./community-securityhub-members/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
