...
const IDENTIFIER = 'arn:community::123456789012:securityhub:master';
...
describe('when calling handler', () => {
    ...
    beforeEach(async () => {
        ...
        securityHub.mock('listInvitations').resolve({
            Invitations: [
                {
    ...
    test('create operation successful - security hub master', async () => {
    ...
    test('update operation successful - security hub master', async () => {
    ...
    test('delete operation successful - security hub master', async () => {
