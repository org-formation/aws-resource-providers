...
export class ResourceModel extends BaseModel {
    ...
    @Exclude()
    public static readonly TYPE_NAME: string = 'Community::Detective::Management';
    ...
    @Transform(
        (value: any, obj: any) =>
            transformValue(String, 'managementAccountId', value, obj, []),
        {
            toClassOnly: true,
        }
    )
    managementAccountId?: Optional<string>;
