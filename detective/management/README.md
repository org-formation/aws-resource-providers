...
1. Write the JSON schema describing your resource, [community-detective-management.json](./community-detective-management.json)
2. Implement your resource handlers in [handlers.ts](./community-detective-management/handlers.ts)

> Don't modify [models.ts](./community-detective-management/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
